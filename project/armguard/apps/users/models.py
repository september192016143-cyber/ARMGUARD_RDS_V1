...
class SystemSettings(models.Model):
    ...
    duty_sentinel_holster_qty     = models.PositiveSmallIntegerField(
        default=1, help_text='Pistol holsters auto-issued per Duty Sentinel withdrawal.')
    duty_sentinel_mag_pouch_qty   = models.PositiveSmallIntegerField(
        default=3, help_text='Magazine pouches auto-issued per Duty Sentinel withdrawal.')
    duty_sentinel_pistol_mag_qty  = models.PositiveSmallIntegerField(
        default=4, help_text='Pistol magazines auto-issued per Duty Sentinel withdrawal.')
    duty_sentinel_pistol_ammo_qty = models.PositiveSmallIntegerField(
        default=42, help_text='Pistol ammunition rounds auto-issued per Duty Sentinel withdrawal.')

    # ── Standard loadout defaults — Duty Security ─────────────────────────────
    duty_security_rifle_mag_qty  = models.PositiveSmallIntegerField(
        default=7, help_text='Rifle magazines auto-issued per Duty Security withdrawal.')
    duty_security_rifle_ammo_qty = models.PositiveSmallIntegerField(
        default=210, help_text='Rifle ammunition rounds auto-issued per Duty Security withdrawal.')
