(function () {
  ...
  qInput.addEventListener('input', function () {
    ...
    debounceTimer = setTimeout(function () { doFetch(buildParams()); }, 400);
  });
  if (typeSelect)  typeSelect.addEventListener('change',  function () { doFetch(buildParams()); });
  if (rangeSelect) rangeSelect.addEventListener('change', function () { doFetch(buildParams()); });
